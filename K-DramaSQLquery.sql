...
INSERT INTO Drama_list (Name_of_Drama, Year_of_release, Aired_Date, Aired_ON,  Network, Rating) VALUES
('Business Proposal', 2022, '2022-02-28', 'Monday & Tuesday', 'Netflix',8.7),
...
create table episode_info
 (
  ...
  insert into episode_info(Name_of_Drama, Number_of_Episode, Duration_of_Episode, Content_Restriction, Cast, Genre) VALUES
  ('Business Proposal', 12, '01:00:00', '15+ - Teens 15 or older', 'Ahn Hyo Seop, Kim Se Jeong, Seol In Ah & Kim Min Kyu', 'Comedy, Romance & Drama'),
